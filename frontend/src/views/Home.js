								...
								<div className="b desc">
									<div className="wrapper">
										<div>
											...
											<p>
												Almost {yearFrontEnd} years in Front End World,
												passionate on animation, elegant color palettes, UI
												trends.
											</p>
											<p>
									...
									<div className="wrapper">
										...
										<div>
											<div className="wrapper">
												<h2>What Can I Do?</h2>
												<p>
													Generally, I can do common what people said about
													frontend field. Aesthetic, beautiful looking,
													interactivity, colors, emotional, users, clients, and
													stuff like that.
												</p>
												<p>
													Specifically, I research, design, and also code web
													apps.
												</p>
											</div>
										</div>
									...
									<div className="wrapper">
										<div>
											<div className="wrapper">
												<h3>Analysis</h3>
												<p>
													Every projects, as a person, I love to research first.
													How the others do that, it could be better than that,
													and how far it can go further.
												</p>
												<p>
													When get stuck, what causes it? Should we make a
													improve or just tweak a few things.
												</p>
											</div>
										</div>
										<div>
											<div className="wrapper">
												<h3>Branding</h3>
												<p>
													I want to my users know what products that I build.
													Then, I should make it easier to everyone to memorize.
												</p>
												<p>
												...
												<p>
													...
													correct. Follow schema.org guidances. So, I aware of
													my apps in order to boost marketing performances.
												</p>
											</div>
										</div>
										<div>
											<div className="wrapper">
												<h3>Server</h3>
												<p>
													When I do projects alone, I handle server by myself.
												</p>
												<p>
													Mostly still traditional hosting or VPS running on
													Apache, NGINX, or even LiteSpeed. Yes. I install them
													manually.
												</p>
												<p>
													When needed, I pay attention to server performances.
													How much Apache can handle concurrent connection?
												</p>
											</div>
										</div>
									</div>
								...
								<ul className="list">
									...
									<li>
										<ul>
											...
											<li>
												...
												<ul className="detail">
													<li>
														Create &amp; maintain Velospace &amp; Co's main
														frontend website.
													</li>
													<li>
														Creating user interfaces, user journey, slicing it
														to HTML &amp; JavaScript.
													</li>
													<li>
										...
										<ul>
											...
											<li>
												<ul className="detail">
													...
													<li>
														<span>
															Ensuring site performances for TEMPO.CO like a
															load speed, readability, and brand awareness.
														</span>
													</li>
													<li>
													...
													<li>
														<span>
															Revamping Cantika.com and Indonesiana.id.
														</span>
													</li>
												</ul>
											</li>
									...
									<li>
										<ul>
											...
											<li>
												<span>
													At Kompas.com, I worked as a part of Digital
													Advertising. Especially for developing client's
													banners, microsite, and related. Work closely with
													account executive to deliver better result for
												...
												<div className="wrapper">
													...
													<div>
														<div className="wrapper">
															...
															<p>
																I should let people know, this site is about
																house and their needs. So I try to make top
																viewport area seamlessly beautiful.
															</p>
														</div>
													</div>
													<div>
													...
													<div>
														<div className="wrapper">
															<p>
																...
																prototype. But I have plan to make it with React
																or maybe another frameworks. This demo is about
																how can I deliver to you what exactly my feel,
																my vision, my imagination about design
																especially in gadget lifestyle industries. I am
																interested on gadget. That's why I created this
																site.
															</p>
														</div>
													</div>
													...
													<div>
														<div className="wrapper">
															<p>
																...
																Uniqlo just because other brand already have
																"OK" user interfaces.
															</p>
														</div>
													</div>
